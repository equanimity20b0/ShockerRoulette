    ...
    def do_GET(self):
        if self.path == "/":
            ...
            status = {
                ...
                "roulette_start_intensity": self.client_instance.roulette_start_intensity,
                "roulette_max_intensity": self.client_instance.roulette_max_intensity,
                "roulette_current_intensity": self.client_instance.roulette_current_intensity
            }
            ...
            self.send_header("Content-Type", "application/json")
            self.end_headers()
            from voice_recog import VoiceRecog
            devices = VoiceRecog.get_input_devices()
